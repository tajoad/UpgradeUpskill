      ...
      <div class="signup-content">
        <form @submit.prevent="register()" id="signup-form" class="signup-form">
          ...
          <div class="form-setup">
            <div
              class="form-group"
              :class="{ error: v$.user.companyName.$errors.length }"
            >
          ...
          <div class="form-setup">
            <div class="form-group">
              ...
              <input
                v-model="v$.user.companyEmail.$model"
                type="email"
                class="form-input"
                name="companyemail"
                id="companyemail"
            ...
            <div
              class="input-errors"
              v-for="(error, index) of v$.user.companyEmail.$errors"
              :key="index"
            >
              <div class="error-msg">{{ error.$message }}</div>
            </div>
        ...
        <p class="loginhere">
          ...
          <router-link class="loginhere-link" to="/"> Login here</router-link>
        </p>
      </div>
    </div>
  </section>
...
const url = "http://localhost:3002/registeradmin";

  ...
  <div class="landingpage-main">
    <div class="welcome">
      <div class="welcome-text">
        ...
        <p><span>"</span>{{ this.getQuote }}<span>"</span></p>
        <p class="text-author">{{ this.getAuthor }}</p>
      </div>
      <div class="welcome-img">
        <img :src="this.updatedImage" alt="" class="welcome-image" />
      </div>
    </div>
    ...
    <div class="box-container">
      <div class="box box1">
        ...
        <div>
          <img src="../images/icons8-learning-50 (3).png" alt="Views" />
        </div>
      </div>
      ...
      <div class="box box3">
        ...
        <div>
          <img src="../images/icons8-in-progress-50.png" alt="comments" />
        </div>
      </div>

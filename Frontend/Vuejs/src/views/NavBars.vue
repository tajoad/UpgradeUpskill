   ...
   <div class="navcontainer">
       <nav class="nav">
        <div class="nav-upper-options">
			<router-link :to="{name: 'Homepage', params: {data: this.id}}" class="button nav-option" exact>
				<i class="fas fa-tachometer-alt fa-fw me-3"></i>
				<span class="text">Dashboard</span>
			</router-link>
			<router-link  :to="{name: 'Profile', params: {id: this.id}}" class="button nav-option">
			...
			<router-link to="/team" class="button nav-option">
				<i class="fa fa-users fa-fw me-3"></i>
				<span class="text">Team</span>
			</router-link>
			<router-link to="/" class="button nav-option">

		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" @submit.prevent="login()">
					...
					<div class="wrap-input100 validate-input" :class="{ error: v$.user.username.$errors.length }">
						<input class="input100" type="text" name="username" placeholder="Username" v-model="v$.user.username.$model">
              ...
              <div class="input-errors" v-for="(error, index) of v$.user.username.$errors" :key="index">
                  <div class="error-msg">{{ error.$message }}</div>
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required" :class="{ error: v$.user.password.$errors.length }">
						<input class="input100" type="password" name="pass" placeholder="Password" v-model="v$.user.password.$model">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
            ...
            <router-link  class="txt2" to="/register"> Create your Account					
          ...
          sendAlert: function(data){
              const getData = JSON.parse(data);
                  ...
                  this.$toast.error(getData.responseMsg,  {
                    ...
                    this.$router.push({name:'Homepage', params: {data: getData.responseMsg}})
                  }
              }
        }
    }
